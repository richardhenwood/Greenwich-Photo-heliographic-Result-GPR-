    ...
    #                        $initialSpotARFF .= " ?";
                    ...
                    if ($daysFromLimb <= $highPreCut && $daysFromLimb >= $lowPreCut) {
                        if ($firstTimePre) {
                            ...
                            my $tmpSpotLatitude = $spot->getLatitude - $previousLatitude; 
                            ...
                            $initialSpotARFF .= $tmpSpotLongitude . " ";
                        }
                        $previousLatitude = $spot->getLatitude;
                        $previousLongitude = $spot->getCarringtonLongitude;
    ...
    #                        $linkedSpotARFF .= " ?";
                    ...
                    if ($daysFromLimb <= $highPostCut && $daysFromLimb >= $lowPostCut) {
                        if ($firstTimePost) {
                            ...
                            $linkedSpotARFF .= $spot->getLatitude - $previousLatitude . " ";
                            $linkedSpotARFF .= $spot->getCarringtonLongitude - $previousLongitude. " ";
                        }
                        $previousLatitude = $spot->getLatitude;
                        $previousLongitude = $spot->getCarringtonLongitude;
