...
#    	System: Linux 2.6.16.27-0.9-smp
#    
...
#GNUTERM = "x11"
plot '< cat /users/rhenwood/ihr/data/testData/logn0-1.10000.txt | /users/rhenwood/ihr/sunspots/perl/warwick/distTest/myBinningCode.pl -f -  -n 100 -s ' u 3:6 w boxes title 'data from lognrnd(0,1,1000)', \
'< ./genStdLogNormal.pl -a 1 -v' u 9:12 title 'log-normal' #, \
#'< /users/rhenwood/ihr/sunspots/perl/warwick/distTest/genStdGumbel.pl' u 9:12 title 'stdGumbel'
#    EOF
