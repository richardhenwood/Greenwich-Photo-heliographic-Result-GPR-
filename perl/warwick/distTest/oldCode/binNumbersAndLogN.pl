...
#            }
            ...
            $i += $logNmean;
            if ($i < 0) { print " logNPDF = NaN preMeandataPDF = NaN postMeandataPDF = NaN "}
            else {
                my $Px = exp(- ((log($i)**2)/2)) / ($i * sqrt(2 * $pi));
                print " logNPDF = " . -log($Px);
                if ($i < $logNmax) {
                    print " preMeandataPDF = " . -log($binContents * 83.52);
                    print " postMeandataPDF = NaN ";
                }
                else {
                    print " preMeandataPDF = NaN ";
                    print " postMeandataPDF = " . -log($binContents * 83.52);
                }
            }
            ...
            if ($i < 0) { print " logNPDF = NaN preMeandataPDF = NaN postMeandataPDF = NaN "}
                ...
                if ($i < $logNmax) {
                    print " preMeandataPDF = " . -log($binContents * 99.64);
                    print " postMeandataPDF = NaN ";
                } else {
                    print " preMeandataPDF = NaN ";
                    print " postMeandataPDF = " . -log($binContents * 99.64);
                }
            }
            ...
            if ($i < 0) { print " logNPDF = NaN preMeandataPDF = NaN postMeandataPDF = NaN "}
                ...
                if ($i < $logNmax) {
                    print " preMeandataPDF = " . -log($binContents * 79.62);
                    print " postMeandataPDF = NaN ";
                } else {
                    print " preMeandataPDF = NaN ";
                    print " postMeandataPDF = " . -log($binContents * 79.62);
                }
            }
