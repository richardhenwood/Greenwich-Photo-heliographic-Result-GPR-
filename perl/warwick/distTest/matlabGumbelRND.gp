...
#GNUTERM = "x11"
plot '< cat /users/rhenwood/ihr/data/testData/gumbel0-1.1000.txt | /users/rhenwood/ihr/sunspots/perl/warwick/distTest/myBinningCode.pl -f - -n 50 -r ' u 3:6 w boxes title 'data from evrnd(0,1,1000)', \
'< ./genGumbel.pl -a 1 -v' u 9:12 title 'Gumbel (a=1)' #, \
