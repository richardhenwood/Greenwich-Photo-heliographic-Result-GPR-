...
GNUTERM = "x11"
plot '< cat /tmp/maxSizeAges/age6.txt | ././binNumbersAndNormalise.pl -n 32 -f -' using 3:6, '< ./genFisherTippett.pl -a 1 -v ' u 9:12, '< cat /tmp/maxSizeAges/age6.txt | ././binNumbersAndNormalise.pl -n 32 -f - | ./genFisherTippett.pl -a 1 -f - ' u 3:6 title 'fn values'
#    EOF
