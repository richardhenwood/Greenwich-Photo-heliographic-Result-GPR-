...
#set xrange [ -2.00000 : 8.00000 ] noreverse nowriteback
...
'< cat /users/rhenwood/ihr/data/grnAge/age6.txt /users/rhenwood/ihr/data/grnAge/age7.txt /users/rhenwood/ihr/data/grnAge/age8.txt | /users/rhenwood/ihr/sunspots/perl/warwick/distTest/myBinningCode.pl -f - -l -h' u 3:6:9:12:15 with candlesticks title 'sunspot observations age 6,7,8', \
'< /users/rhenwood/ihr/sunspots/perl/warwick/distTest/genStdGumbel.pl ' using 9:12 with lines title "stdGumbel"

#'< /users/rhenwood/ihr/sunspots/perl/warwick/distTest/genFrechet.pl -a 1    -v' using 9:12 with lines title "a = 1", \



#'< cat ~/ihr/data/grnAge/age6.txt ~/ihr/data/grnAge/age7.txt ~/ihr/data/grnAge/age8.txt | ~/ihr/sunspots/perl/warwick/distTest/binNumbersAndNormaliseLowerAndUpper.pl -f - ' u 3:6:9:12:15 with candlesticks title 'sunspot observations age 6,7,8', \
