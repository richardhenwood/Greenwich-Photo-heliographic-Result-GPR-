...
'< /users/rhenwood/ihr/sunspots/perl/warwick/distTest/genPoisson.pl -n 30 -l 1    -v' using 9:12 with lines title "Poisson", \
'< /users/rhenwood/ihr/sunspots/perl/warwick/distTest/genFisherTippett.pl -n 500 -a 1    -v' using 9:12 with lines title "Gumbel", \
