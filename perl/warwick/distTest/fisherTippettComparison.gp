...
'< /users/rhenwood/ihr/sunspots/perl/warwick/distTest/genFisherTippett.pl -n 500 -a 0.5    -v' using 9:12 with lines title "a = 0.5", \
'< /users/rhenwood/ihr/sunspots/perl/warwick/distTest/genFisherTippett.pl -n 500 -a 1 -v' using 9:12 with lines title "$a = 1$", \
'< /users/rhenwood/ihr/sunspots/perl/warwick/distTest/genFisherTippett.pl -n 500 -a 2 -v' using 9:12 with lines title "$a = 2$", \
'< /users/rhenwood/ihr/sunspots/perl/warwick/distTest/genFisherTippett.pl -n 500 -a 3    -v' using 9:12 with lines title "a = 3"
