...
plot \
'< /users/rhenwood/ihr/sunspots/perl/warwick/distTest/genStdLogNormal.pl ' using 9:12 smooth csplines title "log normal", \
'< /users/rhenwood/ihr/sunspots/perl/warwick/distTest/genPoisson.pl -n 30 -l 1 ' using 9:12 smooth csplines title "Poisson", \
'< /users/rhenwood/ihr/sunspots/perl/warwick/distTest/genGumbel.pl -n 100 -a 1    -v' using 9:12 smooth csplines title "Gumbel"
...
#'< cat /users/rhenwood/ihr/data/grnAge/ageAll.txt | /users/rhenwood/ihr/sunspots/perl/warwick/distTest/myBinningCode.pl -f - -h ' u 3:6:9:12:15 with candlesticks title 'sunspot observations age 6,7,8',\
#'< /users/rhenwood/ihr/sunspots/perl/warwick/distTest/genStdGumbel.pl -n 100 -a 1 -v' using 9:12 with lines title "analytical std gumbel", \
#'< /users/rhenwood/ihr/sunspots/perl/warwick/distTest/genGumbel.pl -n 10 -a 1.53 -v' using 9:12 with lines title "$a = \over{\pi}{2}$", \
#'< /users/rhenwood/ihr/sunspots/perl/warwick/distTest/genGumbel.pl -n 5 -a 2    -v' using 9:12 with lines title "a = 2"
