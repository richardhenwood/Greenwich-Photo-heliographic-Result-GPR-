...
'< /users/rhenwood/ihr/sunspots/perl/warwick/distTest/genFrechet.pl -n 100 -a 1    -v' using 9:12 with lines title "a = 1", \
'< /users/rhenwood/ihr/sunspots/perl/warwick/distTest/genFrechet.pl -n 10 -a 1.53 -v' using 9:12 with lines title "$a = \over{\pi}{2}$", \
'< /users/rhenwood/ihr/sunspots/perl/warwick/distTest/genFrechet.pl -n 5 -a 2    -v' using 9:12 with lines title "a = 2"
