...
sub printSpotCentricSpots {
    ...
    #'        print Dumper @maxTimeBoundRef;
            ...
            foreach my $obsTime (keys (%sunspotDates)) {
                ...
                #print "dates: $minTimeBound $maxTimeBound $obsTime\n";
                my $minDiff = "";
                my $maxDiff = "";
                eval {
...
sub Load_Sunspot_SpotCentric {
    ...
    while (defined (my $line = <FH>)) {
        ...
        #if ($test_spot->getGroupNumber() - 100 > $previousNumber) {
        #'    $cycle++;
        #    }
        #$previousNumber = $test_spot->getGroupNumber();
        ...
        #$test_spot->putGroupNumber($testSpotGroupNumber);
