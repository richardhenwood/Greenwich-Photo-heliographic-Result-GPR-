...
sub GW_Fix_Group_A_No_0 {
    ...
    while (defined (my $line = <FH>)) {
        ...
        #print $test_spot->getYear() . "-";
        #print $test_spot->getMonth() . "-";
        #print $test_spot->getDayOfMonth() . " ";
        #print $test_spot->getHour() . " ";
        print $test_spot->getDateTime() . " ";
        print $test_spot->getGroupNumber() . " ";
        print $test_spot->getSun_B0() . " ";
#        print $test_spot->getSun_S() . " ";
        print $test_spot->getSolarRadii() . " ";
        print $test_spot->getPositionAngle() . " ";
        print $test_spot->getLatitude() . " ";
        print $test_spot->getLongitude() . "\n";
    }
    exit(0);
}
