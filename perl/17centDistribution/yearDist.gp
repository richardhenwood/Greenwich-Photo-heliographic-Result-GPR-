...
set xlabel "seasonal variation"
#set title "Catalogue of 'red firelike' observations"
set key   samplen 2 autotitles columnhead


plot '< cat ./RSdata.txt | ./genHistogram.pl' using 2 fs solid lc rgb "dark-red" lt 1, \
