...
set xtics 
set xtics   ("Jan" 0.00000, "Feb" 1.00000, "Mar" 2.00000, "Apr" 3.00000, "May" 4.00000, "Jun" 5.00000, "Jul" 6.00000, "Aug" 7.00000, "Sep" 8.00000, "Oct" 9.00000, "Nov" 10.0000, "Dec" 11.0000)
...
set yrange [0:16]
plot \
'< cat RSdata.txt | ./genHistogram.pl' u 4:xtic(2) lt 1 fill pattern 4 title "ILGI catalogue"


set format y "% g"
set ytics ("0" 0, "2" -2, "4" -4, "6" -6, "8" -8, "10" -10, "12" -12, "14" -14, "16" -16)
...
set yrange [-16:0]
plot \
'< cat RSdata.txt | ./genHistogram.pl' u (0-$$6):xtic("") lt 1 fill pattern 7 title "SILLOK catalogue"
